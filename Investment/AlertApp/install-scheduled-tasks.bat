@echo off
REM ============================================================================
REM  Install Windows Task Scheduler jobs that keep the AlertApp Green API
...
echo      - AlertApp-Watchdog  (every 5 minutes)
echo      - AlertApp-Startup   (at logon)
echo.
